...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="'.esc_html__( 'https://metabox.io/docs/', 'rooten' ).'">' . esc_html__( 'Documentation', 'rooten' ) . '</a>';
		$links[] = '<a href="'.esc_html__( 'https://metabox.io/plugins/', 'rooten' ).'">' . esc_html__( 'Extensions', 'rooten' ) . '</a>';
		return $links;
	}
