<article id="post-<?php the_ID() ?>" <?php post_class('broxme_wp-article post-format-link broxme_wp-text-'.get_theme_mod('bangla_blog_align', 'center')) ?> data-permalink="<?php the_permalink() ?>" typeof="Article">
